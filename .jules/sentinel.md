...
- 2026-02-24: [Resource exhaustion] TCP proxy loops using io.Copy or io.CopyBuffer fail to drop idle connections; wrap net.Conn to refresh read/write deadlines on every operation to prevent DoS.
