...
- 2026-06-02: [High] Infinite loop CPU exhaustion in server accept loops via unhandled select break; always ensure goroutines waiting on context cancellation explicitly close the listener to properly interrupt blocking Accept calls.
